                                                    ...
                                                    <tr className="text-center" key={d._id}>
                                                        ...
                                                        <td className='px-5 relative py-5 border-b border-gray-200 bg-white text-sm'>
                                                            <p className='text-gray-900 whitespace-no-wrap'>  <div className="menu-wrapper" ref={menuRef}>
                                                                <div className="menu-trigger relative" onClick={(e) => handleMenuClick(e, `action-${d._id}`)}>
                                                                    ⋮
                                                                </div>
                    ...
                    <>
                        {pages.map(btnNum => (
                            <button
                                ...
                                key={btnNum}
                                className={`hidden ${currentPage === btnNum ? 'bg-blue-500 text-white' : ''} px-4 py-2 mx-1 transition-colors duration-300 transform rounded-full sm:inline hover:bg-blue-500 hover:text-white`}
                            >
                                {btnNum}
                            </button>
                        ))}
